...
function parseHSL(hslStr: string): HslColor {
  ...
  if (!match) return { h: 35, s: 70, l: 65 };
  return {
...
export const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  // Pure Gold highlights only — zero green outlines or unwanted tints
  const effectiveGlowColor = '43 65 55';
  const effectiveColors = ['#C4A460', '#D4AF37', '#DFC17B'];
